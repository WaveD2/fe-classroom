        ...
        <div className="space-y-6">
          ...
          {summary && (
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-xl border p-4 text-center">
                <div className="text-2xl font-bold">{summary.averagePercent}%</div>
                <div className="text-sm text-gray-600">Điểm danh trung bình</div>
              </div>
            </div>
          )}

          <div className="bg-white rounded-2xl border p-4">
            <h2 className="text-lg font-semibold mb-3">Lớp đã tham gia</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="text-left text-gray-600">
                    <th className="p-2">Lớp</th>
                    <th className="p-2">Đi</th>
                ...
                <tbody>
                  {classes.map((c) => (
                    <tr key={c.classId} className="border-t">
                      ...
                      <td className="p-2">{c.attended}</td>
